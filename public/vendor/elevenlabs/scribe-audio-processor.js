 ...
 *
 * Self-hosted verbatim from @elevenlabs/client/worklets/scribeAudioProcessor.js
 * so it loads under this site's CSP without whitelisting blob:/data: URLs in
 * script-src — see use-ambient-session.ts's useScribe({ microphone: { workletPaths } }).
 */
